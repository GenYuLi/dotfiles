return {
  {
    ...
    keys = {
      ...
      { '<M-S-Up>',    function() require('smart-splits').move_cursor_up() end,    mode = { "", "!" }, desc = "move cursor up" },
      { '<M-S-Down>',  function() require('smart-splits').move_cursor_down() end,  mode = { "", "!" }, desc = "move cursor down" },
      { '<M-S-Left>',  function() require('smart-splits').move_cursor_left() end,  mode = { "", "!" }, desc = "move cursor left" },
      { '<M-S-Right>', function() require('smart-splits').move_cursor_right() end, mode = { "", "!" }, desc = "move cursor right" },
      -- stylua: ignore end
    },
  },
